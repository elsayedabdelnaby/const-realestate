...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        <img src="{{ asset('public/admin/images/vendor/admin-lte/dist') }}/AdminLTELogo.png" alt="AdminLTE Logo"
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ asset('public/admin/images/vendor/admin-lte/dist') }}/user2-160x160.jpg"
