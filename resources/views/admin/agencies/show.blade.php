                ...
                <form class="col-12">
                        ...
                        @foreach (config('translatable.locales') as $locale)
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control input-thick ckeditor" type="text" name="{{ $locale }}[description]">{{ $agency->translate($locale)-> description }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="{{ $locale }}[address]">Address in @lang('site.' . $locale . '.name')</label>
                                    <textarea class="form-control input-thick" type="text" name="{{ $locale }}[address]">{{ $agency -> translate($locale)-> address }}</textarea>
                                </div>
                            </div>
                        @endforeach
                    </div>
                            ...
                            <div class="text-center col-sm-12 col-md-6 border-right">
                                ...
                                <div class="form-group col-sm-12 col-md-12">
                                    ...
                                    <select name="country_id" class="form-control">
                                        <option selected>{{ $agency -> country -> name }}</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-sm-12 col-md-12">
                                    ...
                                    <select name="city_id" class="form-control">
                                        <option selected>{{ $agency -> city -> name }}</option>
                                    </select>
                                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-lg-6">
                            <label>E-Mail</label>
                            <input type="text" name="email" class="form-control form-control-sm input-sm disabled" value="{{ $agency -> email }}">
                        </div>
