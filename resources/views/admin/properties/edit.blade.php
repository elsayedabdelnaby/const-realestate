    ...
    <div class="card card-solid">
        <div class="card-body">
            <div class="row">
                ...
                <form class="col-12" action="{{ route('admin.properties.update', $property->id) }}" method="post"
                            ...
                            <select name="agency_id" class="form-control">
                                ...
                                @foreach ($agencies as $agency)
                                    <option value="{{ $agency->id }}"
                                        {{ $property->agency_id == $agency->id ? 'selected' : '' }}>
                                        {{ $property->agency->name }}</option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-thick" type="text"
                                        ...
                                        value="{{ $property->translate($locale)->meta_title }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-thick" type="text"
                                        ...
                                        value="{{ $property->translate($locale)->meta_keywords }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-thick" type="text"
                                        ...
                                        value="{{ $property->translate($locale)->meta_description }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-thick" type="text"
                                        ...
                                        value="{{ $property->translate($locale)->meta_slug }}">
                                </div>
                            ...
                            <table class="table table-striped table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr style="text-transform: capitalize">
                                        <td>
                                            <label for="is_active">
                                                <input class="___class_+?47___" type="checkbox" name="is_active"
                                                    {{ $property->is_active == 1 ? 'checked' : '' }}>
                                            </label>
                                        </td>
                                        <td>
                                            <label for="rent_sale">
                                                <input class="___class_+?48___" type="radio" name="rent_sale"
                                                    {{ $property->rent_sale == 0 ? 'checked' : '' }} value="sale">
                                            </label>
                                        </td>
                                        <td>
                                            <label for="rent_sale">
                                                <input class="___class_+?49___" type="radio" name="rent_sale"
                                                    {{ $property->rent_sale == 1 ? 'checked' : '' }} value="rent">
                                            </label>
                                        </td>
                                        <td>
                                            <label for="is_featured">
                                                <input class="___class_+?50___" type="checkbox" name="is_featured"
                                                    {{ $property->is_featured == 1 ? 'checked' : '' }}>
                                            </label>
                                        </td>
                                        <td>
                                            <label for="add_to_home">
                                                <input type="checkbox" name="add_to_home"
                                                    {{ $property->add_to_home == 1 ? 'checked' : '' }}>
                                            </label>
                                        </td>
                                    </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-lg-3">
                                    ...
                                    <input type="number" name="construction_area" class="form-control"
                                        value="{{ $property->construction_area }}">
                                </div>
                                    ...
                                    <select name="property_type_id" class="form-control">
                                        ...
                                        @foreach ($property_types as $property_type)
                                            <option value="{{ $property_type->id }}"
                                                {{ $property->property_type_id == $property_type->id ? 'selected' : '' }}>
                                    ...
                                    <select name="property_status_id" class="form-control">
                                        ...
                                        @foreach ($property_statuses as $property_status)
                                            <option value="{{ $property_status->id }}"
                                                {{ $property->property_status_id == $property_status->id ? 'selected' : '' }}>
