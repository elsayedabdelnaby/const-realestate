    ...
    <div class="card card-solid">
        <div class="card-body">
            <div class="row">
                ...
                <form class="col-12" action="{{ route('admin.projects.update', $project -> id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            <select name="agency_id" class="form-control">
                                ...
                                @foreach ($agencies as $agency)
                                    <option value="{{ $agency -> id }}" {{ $project->agency_id == $agency->id ? 'selected' : '' }}>{{ $project -> agency -> name }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row">
                        @foreach (config('translatable.locales') as $locale)
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="{{ $locale }}[description]">project Description in @lang('site.' . $locale . '.name')</label>
                        ...
                        <div class="form-group col-sm-12 col-lg-12 card card-primary card-outline">
                            ...
                            <table class="table table-striped table-bordered text-center">
                                ...
                                <tr style="text-transform: capitalize">
                                    <td>
                                        <label for="is_active">
                                            <input class="" type="checkbox" name="is_active" {{ $project -> is_active == 1 ? 'checked' : '' }}>
                                        </label>
                                    </td>
                                    <td>
                                        <label for="is_featured">
                                            <input class="" type="checkbox" name="is_featured" {{ $project -> is_featured == 1 ? 'checked' : '' }}>
                                        </label>
                                    </td>
                                    <td>
                                        <label for="finish_status">
                                            <input type="checkbox" name="finish_status" {{ $project -> finish_status == 1 ? 'checked' : '' }}>
                                        </label>
                                    </td>
                                </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-lg-3">
                                    ...
                                    @enderror
                                    <input type="number" name="area_from" class="form-control" value="{{ $project->area_from }}">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <span class="text-danger mx-1">{{ $message }}</span>
                                    @enderror
                                    <input type="number" name="price_from" class="form-control" value="{{ $project->price_from }}">
                                </div>
                                ...
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <span class="text-danger mx-1">{{ $message }}</span>
                                    @enderror
                                    <input type="number" name="price_to" class="form-control" value="{{ $project->price_to }}">
                                </div>
                                ...
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <span class="text-danger mx-1">{{ $message }}</span>
                                    @enderror
                                    <input type="number" name="downpayment" class="form-control" value="{{ $project->downpayment }}">
                                </div>
                                ...
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <span class="text-danger mx-1">{{ $message }}</span>
                                    @enderror
                                    <input type="number" name="installments_years" class="form-control" value="{{ $project->installments_years }}">
                                </div>
                            ...
                            <div class="row col-sm-12">
                                    ...
                                    <div class="form-group col-sm-12 col-md-12">
                                        ...
                                        <select name="city_id" class="form-control">
                                            ...
                                            @foreach ($cities as $city)
                                                <option value="{{ $city -> id }}" {{ $project -> city_id   == $city -> id ? 'selected' : '' }}>{{ $city -> name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="text-center col-sm-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger mx-1">{{ $message }}</span>
                                        @enderror
                                        <input type="text" name="google_map_link" value="{{ $project->google_map_link }}" class="form-control">
                                    </div>
                            ...
                            <div class="row col-sm-12">
                                ...
                                <div class="text-center col-sm-12 col-md-4 border-right">
                                    ...
                                    <div class="form-group col-sm-12 col-lg-12">
                                        ...
                                        <span class="text-danger mx-1">{{ $message }}</span>
                                        @enderror
                                        <input type="text" name="video_link" class="form-control input-sm" value="{{ $project->video_link}}">
                                    </div> {{-- end of form group image --}}
                                </div>
                            </div>
