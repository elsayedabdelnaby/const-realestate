            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    ...
                    <form id="contactform" class="contact-form" name="contactform" method="post" novalidate
                        action="{{ route('front.store.contact-us') }}">
                        @csrf
                        ...
                        @auth
                            ...
                            <div class="form-group">
                                <input type="text" required class="form-control input-custom input-full" name="name"
                                    placeholder="Name" value="{{ auth()->user()->first_name . ' ' . auth()->user()->last_name }}">
                            </div>
                            <div class="form-group">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="info cll">
                                    ...
                                    <p class="in-p ti">{{ $contact_us_info->start_working_at }} -
                                        {{ $contact_us_info->end_working_at }}</p>
                                </div>
                            </li>
                        </ul>
                    </div>
